...
def main():
    with gemini_pro:
        st.header("Interact with Research chat")
        st.write("here you can ask for you intersting questions ,NO LIMITS !")

        prompt = st.text_input("prompt here ⬇", placeholder="paste your interesting question", label_visibility="visible")
